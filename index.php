...
<body onload="ccgen();  onLoadChks();"style="background: <?php echo $theme_background ?>;">
    <audio src="a4.mp3" autoplay="true"></audio>
	<div class="container" id="container">
			...
			<div class="col-md-8">
				<form>
					<div class="form-group">
						<label for="cards" style="color: <?php echo $theme_text ?>; margin-left: 20px">𝐀𝐏𝐈 𝐁𝐘  【★𝘽𝙂★】   ××××  [𝐂𝐇𝐄𝐂𝐊𝐄𝐑 𝐈𝐃 = 𝐀𝟒]</label>
						<textarea type="text" class="form-control" style="border-color: #dc3545;background: transparent;color: <?php echo $theme_text ?>;overflow:hidden" id="cards" rows="5" placeholder="𝐄𝐍𝐓𝐄𝐑 𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃 𝐂𝐀𝐑𝐃𝐒 𝐇𝐄𝐑𝐄" required></textarea>
					</div>
					<div class="form-group">
						<label for="sk" style="color: <?php echo $theme_text ?>; margin-left: 20px">𝐆𝐀𝐓𝐄</label>
						<div class="input-group mb-3 ">
							...
							<div class="input-group-append">
								...
								<button class="btn btn-outline-danger" type="button" onclick="modalCCGEN();">𝐂𝐂 𝐆𝐄𝐍</button>
							</div>
						</div>
						
					</div>
					<div class="form-group" id="hidden_div" style="display:none;">
						<label for="sk" style="color: <?php echo $theme_text ?>; margin-left: 20px">𝐒𝐊 𝐊𝐄𝐘 </label>
						<div class="input-group mb-3">
							<input type="text" class="form-control" style="border-color: #dc3545;background: transparent;color: <?php echo $theme_text ?>;" id="sk" aria-describedby="sk" placeholder="𝐄𝐍𝐓𝐄𝐑 𝐒𝐊 𝐊𝐄𝐘 𝐇𝐄𝐑𝐄" value="<?php if(isset($_COOKIE['sk_stored'])){echo $_COOKIE['sk_stored'];}?>">
							<div class="input-group-append">
								...
								<button class="btn btn-outline-danger" type="button" onclick="checkSK();">𝐂𝐇𝐄𝐂𝐊 𝐊𝐄𝐘</button>
							</div>
						</div>
					</div>
					<button style="margin-top: 20px" type="button" class="btn btn-outline-danger btn-block" onclick="checkCards();">𝐒𝐓𝐀𝐑𝐓</button>
				</form>
			</div>
			<div class="col-md-2"></div>
		</div>
			...
			<div class="col-md-8">
				<form>
					<div class="form-group">
						<div class="row">
							<div class="col-4">
								<button id="cardsLiveCVV" name="cardsLiveCVV" type="button" class="btn btn-outline-primary btn-block"> 𝐂𝐕𝐕: <span id="approved_counter_cvv">0</span></button>
								<div class="row">
									<div class="col-sm-4"></div>
									<div class="col-12 col-sm-8">
										<button type="button" style="margin-top: 10px;" name="clear_cvv" id="clear_cvv" class="btn btn-danger btn-sm btn-block" onclick="clearCVV();">𝐂𝐋𝐄𝐀𝐑 𝐂𝐕𝐕</button>
									</div>
								</div>
							</div>
							<div class="col-4">
								<button id="cardsLiveCCN" name="cardsLiveCCN" type="button" class="btn btn-outline-warning btn-block">𝐂𝐂𝐍: <span id="approved_counter_ccn">0</span></button>
								<div class="row">
									<div class="col-sm-4"></div>
									<div class="col-12 col-sm-8">
										<button type="button" style="margin-top: 10px;" name="clear_ccn" id="clear_ccn" class="btn btn-danger btn-sm btn-block" onclick="clearCCN();">𝐂𝐋𝐄𝐀𝐑 𝐂𝐂𝐍</button>
									</div>
								</div>
							</div>
							<div class="col-4">
								<button id="cardsDead" name="cardsDead" type="button" class="btn btn-outline-danger btn-block">𝐃𝐄𝐀𝐃 : <span id="decline_counter">0</span></button>
								<div class="row">
									<div class="col-sm-4"></div>
									<div class="col-12 col-sm-8">
										<button type="button" style="margin-top: 10px;" name="clear_dead" id="clear_dead" class="btn btn-danger btn-sm btn-block" onclick="clearDead();">𝐂𝐋𝐄𝐀𝐑 𝐃𝐄𝐀𝐃</button>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-md-6 col-12">
						<center>
							<?php 
								if (!isset($_COOKIE['checker_theme'])) {
									echo '<button type="button" onclick="lightmode();" class="btn btn-outline-light">𝐋𝐈𝐆𝐇𝐓 𝐌𝐎𝐃𝐄</button>';
								}else{
									if($_COOKIE['checker_theme'] == 'dark'){
										echo '<button type="button" onclick="lightmode();" class="btn btn-outline-light">𝐋𝐈𝐆𝐇𝐓 𝐌𝐎𝐃𝐄</button>';
									}else{
										echo '<button type="button" onclick="darkmode();" class="btn btn-outline-dark">𝐃𝐀𝐑𝐊 𝐌𝐎𝐃𝐄</button>';
									}
								}
							?>
						</center>
		...
		<div class="footer" id="footer"><center><p style="color: <?php echo $theme_text ?>">
		  ⬇ 𝐈𝐍𝐃𝐄𝐗 𝐁𝐘 ⬇</p></center></div>
	</div>
			...
			<div class="modal-content" style="background: transparent;">
				<div class="modal-body" style="background: <?php echo $theme_background ?>">
					<center style="margin-bottom: 20px">
						...
						<h5 class="modal-title" id="exampleModalCenterTitle" style="color: <?php echo $theme_text ?>">𝐂𝐂 𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐎𝐑</h5>
					</center>
						...
						<div>
							<div class="row">
								<div class="col-8 col-lg-8">
									<div class="form-group">
										<label class="form-control-label" style="margin-left: 10px;color: <?php echo $theme_text ?>" for="inputbin">𝐁𝐈𝐍</label>
										<input id="ccpN" name="ccp" maxlength="19" type="text" id="inputbin" class="form-control" style="border-color: #dc3545;background: transparent;color: <?php echo $theme_text ?>" placeholder="𝐄𝐍𝐓𝐄𝐑 𝐁𝐈𝐍 𝐇𝐄𝐑𝐄">
									</div>
								</div>
								<div class="col-4 col-lg-4">
									<div class="form-group">
										<label class="form-control-label" style="margin-left: 10px;color: <?php echo $theme_text ?>" for="inputcvv">𝐂𝐕𝐕</label>
							...
							<div class="row">
								<div class="col-4 col-lg-4">
									<div class="form-group">
										...
										<label class="form-control-label" style="margin-left: 10px;color: <?php echo $theme_text ?>" for="inputmonth">𝐌𝐎𝐍𝐓𝐇</label>
								...
								<div class="col-4 col-lg-4">
									<div class="form-group">
										<label class="form-control-label" style="margin-left: 10px;color: <?php echo $theme_text ?>" for="inputyear">𝐘𝐄𝐀𝐑</label>
								...
								<div class="col-4  col-lg-4">
									<div class="form-group">
										<label class="form-control-label" style="margin-left: 10px;color: <?php echo $theme_text ?>" for="inputquantity">𝐐𝐔𝐀𝐍𝐓𝐈𝐓𝐘</label>
							...
							<div class="row">
								<button type="button" style="margin-right: 20px;margin-left: 20px;" class="btn btn-outline-danger btn-block"  name="gerar" id="gerar" onclick="playClick();">𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄</button>
							</div>
						</div>
					</form>
				</div>
