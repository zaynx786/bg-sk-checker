...
if(isset($res1['error'])){
    ...
    if($code == "incorrect_cvc"||$decline_code == "incorrect_cvc"){
        ...
        EchoMessage('CCN LIVE',$cc_info.'<<<~~|💘 【★𝘽𝙂★】  💘 |~~>>> '.$err );
        ...
        EchoMessage('CVV LIVE',$cc_info.'<<<~~|💘 【★𝘽𝙂★】  💘 |~~>>> '.$err);
        ...
        //TESTMODE CHARGES
        EchoMessage('DEAD',$cc_info.'<<<~~|💘 【★𝘽𝙂★】  💘 |~~>>>  SK KEY IS DEAD : Test Mode Charges Only【★】 ');
    }elseif(strpos($curl1, 'Sending credit card numbers directly to the Stripe API is generally unsafe.')) {
        //INTEGRATION ERROR
        EchoMessage('DEAD',$cc_info.'<<<~~|💘 【★𝘽𝙂★】  💘 |~~>>> SK KEY IS DEAD : Integration 【★】');
        ...
        //VERIFY NUMBER
        EchoMessage('DEAD',$cc_info.'<<<~~|💘 【★𝘽𝙂★】  💘 |~~>>> SK KEY IS DEAD : Phone Number Is Not Verified【★】');
    }else{
        //DEAD
        EchoMessage('DEAD',$cc_info.'<<<~~|💘 【★𝘽𝙂★】  💘 |~~>>> '.$err);
    }
}else{
    if (isset($res2['error'])) {
        //DEAD
        ...
        if (isset($res2['sources'])) {
            ...
            if($cvc_res2 == "pass"||$cvc_res2 == "success"){
                ...
                EchoMessage('CVV LIVE',$cc_info.'<<<~~|💘 【★𝘽𝙂★】  💘 |~~>>> cvc_check : '.$cvc_res2);
            }else{
                //DEAD
                EchoMessage('DEAD',$cc_info.'<<<~~|💘 【★𝘽𝙂★】  💘 |~~>>> cvc_check : '.$cvc_res2);
            }
        }else{
            ...
            if($cvc_res3 == "pass"||$cvc_res3 == "success"){
                ...
                EchoMessage('CVV LIVE',$cc_info.'<<<~~|💘 【★𝘽𝙂★】  💘 |~~>>> cvc_check : '.$cvc_res3);
            }else{
                //DEAD
                EchoMessage('DEAD',$cc_info.'<<<~~|💘 【★𝘽𝙂★】  💘 |~~>>> cvc_check : '.$cvc_res3);
            }
        }
    }
}
